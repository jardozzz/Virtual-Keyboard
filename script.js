...
comment.innerHTML = 'Клавиатура создана в Windows <br> Переключение языков по комбинации LCtrl+LAlt <br> Иногда возникает баг с отображенеим стрелок,видимо зависит от внутренней кодировки';
